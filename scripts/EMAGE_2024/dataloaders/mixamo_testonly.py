...
class CustomDataset(Dataset):
    ...
    #----------------Copy from beat_sep_lower.py-----------##
        ...
        preloaded_dir = self.data_dir + self.args.cache_path + self.args.test_data_path + f"{self.pose_rep}_cache"
        ...
        #     print("cache path:", preloaded_dir)
        ...
        # print(f"abc: {preloaded_dir}")
        # /data/nas07/PersonalData/danh/EMAGEMixamo/mixamo_english_30_4_811_all/test_norm/all_pose/bvh_rot_full_cache
...
class MotionPreprocessor:
    ...
    def get(self):
        ...
        # filtering
        # if self.skeletons != []:   # phiên bản emagepy38
