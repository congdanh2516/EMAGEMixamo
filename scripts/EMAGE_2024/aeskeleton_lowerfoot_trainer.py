...
class CustomTrainer(train.BaseTrainer):
    ...
    def train(self, epoch):
        ...
        # print("PRINT TEST DATALOADER")
        # # In mẫu tại chỉ số cụ thể
        # sample_index = 2
        # sample = dataset[sample_index]
        # print(f"Sample {sample_index}:")
        # print("Input:", sample[0])  # Dữ liệu đầu vào
        # print("Target:", sample[1])  # Nhãn
        ...
        for its, dict_data in enumerate(self.train_loader):
            ...
            rec_pose = net_out["rec_pose"] # [:, :, :j*3]

            print("REC POSE: ", net_out.keys())
