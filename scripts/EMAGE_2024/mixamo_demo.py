    ...
    def test_demo(self, epoch):
        ...
        with torch.no_grad():
            for its, batch_data in enumerate(self.test_loader):
                ...
                result_path = f"{results_save_path}res_{test_seq_list[its]}"
...
demo = gr.Interface(
    ...
    outputs=gr.File(label="Download your BVH result"),
    title='EMAGE: MIXAMO Audio-driven Avatar',
    description="1. Upload your audio.  <br/>\
        2. Then, sit back and wait for the rendering to happen! This may take a while. <br/>\
        3. After, you can view the videos.  <br/>",
    # article="Relevant links: [Project Page](https://pantomatrix.github.io/EMAGE/)", 
    # examples=examples,
)

# demo.queue(concurrency_count=1, max_size=5).launch(share=True)
