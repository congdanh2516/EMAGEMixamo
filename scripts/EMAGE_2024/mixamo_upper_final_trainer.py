...
class CustomTrainer(train.BaseTrainer):
    ...
    def train(self, epoch):
        ...
        for its, dict_data in enumerate(self.train_loader):
            ...
            tar_pose = rc.euler_angles_to_matrix(tar_pose.reshape(bs, n, j, 3), "YXZ") # ([32, 64, 14, 3, 3])
            ...
            # recon_loss_left_arm =  self.rec_loss(tar_left_arm, rec_left_arm)
            # self.loss_meters['rec_left_arm_loss'].update(recon_loss_left_arm.item())
            # loss +=recon_loss_left_arm*0
    ...
    def val(self, epoch):
        ...
        with torch.no_grad():
            ...
            for its, dict_data in enumerate(self.val_loader):
                ...
                # val_loss +=recon_loss_left_arm*0
